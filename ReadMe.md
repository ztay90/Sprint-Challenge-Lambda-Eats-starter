...
Provides access to the match object. A good use case would be to construct nested paths.

2. How would you explain form validation to someone who has never programmed before?

Form validation makes it so users have to fill out certain parts of a form and can have certain input requirements to be able to submit forms.
